...
export const LOCALES = {
  zh: {
    ...
    hubTitle: "不知道从哪逛？",
    hubNote: "下面这些入口，比翻列表快",
    hubGroupRank: "精选榜单",
    hubGroupDeep: "深度内容",
    hubLocalFirst: "不上传文件的工具",
    hubReport: "独立开发者存活报告",
    hubWeekly: "本周新收录",
    hubPdf: "在线 PDF 工具",
    hubTranslate: "在线翻译工具",
  ...
  en: {
    ...
    hubNote: "These entries get you there faster than scrolling",
    hubGroupRank: "Curated lists",
    hubGroupDeep: "Deep dives",
    hubLocalFirst: "Tools that never upload your files",
    hubReport: "Survival data report",
    hubWeekly: "Added this week",
    hubPdf: "Online PDF tools",
    hubTranslate: "Online translation tools",
    // Site-wide footer category nav
    footerCatsLabel: "Categories",
    a11yFooterCats: "Browse by category",
