...
- [x] 公安备案通过 → 挂公安备案号 + 图标到页脚 ✅ 2026-09-21
      （湘公网安备43010402003127号 · 官方徽标本地托管为 `/mps-beian.png` ·
      由 `build.mjs` 的 `injectBeian()` 全站注入，含 `/en/` 与 2951 个详情页）
- [ ] 境外线路分流（流量起来后）
- [ ] 内容 SEO：分类独立页 ✅ 已完成（87 个分类页，2026-09-15）
- [ ] "提交收录"前端表单
- [ ] 变化统计展示
